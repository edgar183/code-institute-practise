...
def even_number_of_evens1(numbers):
    """
    Returns the number of even numbers contained in a list of numbers.
    `numbers` should be a list containing numbers
...
# Our set of test cases
assert even_number_of_evens1([]) == False, "No numbers"
assert even_number_of_evens1([2]) == False, "One even number"
assert even_number_of_evens1([2, 4]) == True, "Two even numbers"
assert even_number_of_evens1([2, 3]) == False, "Two numbers, only one even"
assert even_number_of_evens1([2, 3, 9, 10, 13, 7, 8]) == False, "Multiple numbers, three even"
assert even_number_of_evens1([2, 3, 9, 10, 13, 7, 8, 5, 12]) == True, "Multiple numbers, four even"
assert even_number_of_evens1([1, 3, 9]) == False, "No even numbers"
